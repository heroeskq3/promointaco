<?php
if ($action == "add") {
    header('Location: surveyposition.php?Id=' . $Id);
    die();
}
//Update survey item
if ($action == "update") {
    header('Location: surveyposition_update.php?Id=' . $Id);
    die();
}

//Delete survey item
if ($action == "delete") {
    class_surveyPositionDelete($Id);
...
//survey list
$surveylist  = class_surveyPositionList();
