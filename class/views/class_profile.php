...
if (isset($_POST['form_usersInfoUpdate'])) {
    $usersInfoUpdate = class_usersInfoUpdate($UserId, $FirstName, $LastName, $Email);
                    ...
                    <div class="row">
                        <div data-provides="fileinput" class="fileinput fileinput-new col-lg-3">
                            <div data-trigger="fileinput" class="fileinput-preview thumbnail img-circle img-responsive">
                                <img src="upload/profile/<?php echo $row_usersInfo['Image']; ?>" alt="<?php echo $row_usersInfo['FullName']; ?>">
                            </div>
                        ...
                        <div class="col-lg-9 custom-col-9">
                            ...
                            <div class="row">
                                ...
                                <form class="form-horizontal" id="form_usersInfoUpdate" method="post" action="">
