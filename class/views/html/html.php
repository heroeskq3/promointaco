...
<head>
    ...
    <title><?php echo CONFIG_METATITTLE . ' | ' . $sectionParams['tittle'] ; ?></title>
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo PATH_VENDOR;?>bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.6.3/css/bootstrap-select.min.css" />
    <!-- MetisMenu CSS -->
    <link href="<?php echo PATH_VENDOR;?>metisMenu/metisMenu.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo PATH_DIST;?>css/sb-admin-2.css" rel="stylesheet">
    <!-- Morris Charts CSS -->
