...
<nav class="navbar navbar-inverse navbar-fixed-top pmd-navbar pmd-z-depth">
    ...
    <div class="container-fluid">
        <div class="pmd-navbar-right-icon pull-right navigation">
            <!-- <?php echo LANG_NEWNOTIFICATIONS; ?> -->
                ...
                <div class="dropdown-menu dropdown-menu-right pmd-card pmd-card-default pmd-z-depth" role="menu">
                    ...
                    <div class="pmd-card-title">
                        <div class="media-body media-middle">
                            <a href="notifications.php" class="pull-right">3 <?php echo LANG_NEWNOTIFICATIONS; ?></a>
                            <h3 class="pmd-card-title-text"><?php echo LANG_NOTIFICATIONS; ?></h3>
                        </div>
                    </div>
                    <!-- <?php echo LANG_NEWNOTIFICATIONS; ?> list -->
                    <ul class="list-group pmd-list-avatar pmd-card-list">
                        <li class="list-group-item" style="display:none">
                            <p class="notification-blank">
                                ...
                                <span><?php echo LANG_YOUDONTHAVEANYNOTIFICATIONS; ?></span>
                            </p>
                        </li>
                        <li class="list-group-item unread">
                            <a href="javascript:void(0)">
                                ...
                                <div class="media-body">
                                    ...
                                    <?php echo LANG_POSTEDANEWCHALLANEGS; ?>
                                    </span>
                                    <span class="list-group-item-text">5 <?php echo LANG_MINUTESAGO; ?></span>
                                </div>
                            </a>
                        </li>
        ...
        <div class="navbar-header">
            ...
            <a href="index.php" class="navbar-brand">
                <!--
                    ...
                    -->
                <img src="themes/images/<?php echo CONFIG_LOGOHEADER; ?>" height="40px">
                <g>
                    <g>
